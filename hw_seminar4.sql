CREATE DATABASE IF NOT EXISTS hw_seminar4;
USE hw_seminar4;
...
SELECT `shops`.`shopname` AS 'Магазин', `cats`.`name` AS 'Котик'
FROM shops
JOIN cats
...
SELECT an_name AS 'Название анализа', an_price AS 'Цена' 
FROM analysis
JOIN orders
ON an_id = ord_an
